...
taskset 0x8 ./install/lib/paper_evaluation/timers_only $duration rm | tee trace-timers-only.rm.$UU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only $duration edf | tee trace-timers-only.edf.$UU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only $duration events | tee trace-timers-only.events.$UU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only $duration static | tee trace-timers-only.static.$UU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only $duration default | tee trace-timers-only.default.$UU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_high_utilization $duration rm | tee trace-timers-only.rm.$HU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_high_utilization $duration edf | tee trace-timers-only.edf.$HU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_high_utilization $duration events | tee trace-timers-only.events.$HU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_high_utilization $duration static | tee trace-timers-only.static.$HU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_high_utilization $duration default | tee trace-timers-only.default.$HU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_over_utilization $duration rm | tee trace-timers-only.rm.$OU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_over_utilization $duration edf | tee trace-timers-only.edf.$OU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_over_utilization $duration events | tee trace-timers-only.events.$OU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_over_utilization $duration static | tee trace-timers-only.static.$OU.log
...
taskset 0x8 ./install/lib/paper_evaluation/timers_only_over_utilization $duration default | tee trace-timers-only.default.$OU.log
