...
./install/lib/rtss_evaluation/timers_only_high_utilization $duration rm ro | tee timers-only-rm-ro.log
ros2 trace stop timers-only-rm-ro

ros2 trace start timers-only-rm-re
./install/lib/rtss_evaluation/timers_only_high_utilization $duration rm re | tee timers-only-rm-re.log
ros2 trace stop timers-only-rm-re

ros2 trace start timers-only-edf-ro
./install/lib/rtss_evaluation/timers_only_high_utilization $duration edf ro | tee timers-only-edf-ro.log
ros2 trace stop timers-only-edf-ro

ros2 trace start timers-only-edf-re
./install/lib/rtss_evaluation/timers_only_high_utilization $duration edf re | tee timers-only-edf-re.log
ros2 trace stop timers-only-edf-re

ros2 trace start timers-only-events-ro
./install/lib/rtss_evaluation/timers_only_high_utilization $duration events ro | tee timers-only-events-ro.log
ros2 trace stop timers-only-events-ro

ros2 trace start timers-only-events-re
./install/lib/rtss_evaluation/timers_only_high_utilization $duration events re | tee timers-only-events-re.log
ros2 trace stop timers-only-events-re

ros2 trace start timers-only-default
./install/lib/rtss_evaluation/timers_only_high_utilization $duration default | tee timers-only-default.log
