...
chrt -f 50 ./install/lib/rtss_evaluation/sequences $duration rm ro | tee trace-sequences.rm.ro.uu.log
ros2 trace stop trace-sequences.rm.ro.uu

ros2 trace start trace-sequences.rm.re.uu
chrt -f 50 ./install/lib/rtss_evaluation/sequences $duration rm re | tee trace-sequences.rm.re.uu.log
ros2 trace stop trace-sequences.rm.re.uu

ros2 trace start trace-sequences.events.ro.uu
chrt -f 50 ./install/lib/rtss_evaluation/sequences $duration events ro | tee trace-sequences.events.ro.uu.log
ros2 trace stop trace-sequences.events.ro.uu

ros2 trace start trace-sequences.events.re.uu
chrt -f 50 ./install/lib/rtss_evaluation/sequences $duration events re | tee trace-sequences.events.re.uu.log
...
chrt -f 50 ./install/lib/rtss_evaluation/sequences_high_utilization $duration rm ro | tee trace-sequences.rm.ro.hu.log
ros2 trace stop trace-sequences.rm.ro.hu

ros2 trace start trace-sequences.rm.re.hu
chrt -f 50 ./install/lib/rtss_evaluation/sequences_high_utilization $duration rm re | tee trace-sequences.rm.re.hu.log
ros2 trace stop trace-sequences.rm.re.hu

ros2 trace start trace-sequences.events.ro.hu
chrt -f 50 ./install/lib/rtss_evaluation/sequences_high_utilization $duration events ro | tee trace-sequences.events.ro.hu.log
ros2 trace stop trace-sequences.events.ro.hu

ros2 trace start trace-sequences.events.re.hu
chrt -f 50 ./install/lib/rtss_evaluation/sequences_high_utilization $duration events re | tee trace-sequences.events.re.hu.log
