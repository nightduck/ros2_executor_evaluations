...
chrt -f 50 ./install/lib/rtss_evaluation/sequences $duration rm | tee trace-sequences.rm.ro.uu.log
ros2 trace stop trace-sequences.rm.uu

ros2 trace start trace-sequences.events.uu
chrt -f 50 ./install/lib/rtss_evaluation/sequences $duration events | tee trace-sequences.events.ro.uu.log
...
chrt -f 50 ./install/lib/rtss_evaluation/sequences_high_utilization $duration rm | tee trace-sequences.rm.ro.hu.log
ros2 trace stop trace-sequences.rm.hu

ros2 trace start trace-sequences.events.hu
chrt -f 50 ./install/lib/rtss_evaluation/sequences_high_utilization $duration events | tee trace-sequences.events.ro.hu.log
